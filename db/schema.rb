...
ActiveRecord::Schema.define(version: 20150828145408) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "banneres", force: :cascade do |t|
  ...
  add_foreign_key "galeria", "categoria", column: "categoria_id", name: "imagenes_galerias_categoria_id_fkey"
